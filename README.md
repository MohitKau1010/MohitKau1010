<!-- ### Hey there, I'm  Mohit Kaushik <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" height="25px" width="25px"> -->

<div align="left">
<p align="left">Let's connect!</p>


<a href="https://www.linkedin.com/in/mohitkau1010">
...
<!--<div align="left">-->
<p align="left">Nominate me as GitHub Star ⭐</p>
...
### Technical Lead, Senior Software Developer & Mobile Software Architect.



Welcome to my GitHub profile! I'm a **Flutter Developer** with 6+ years of experience in building mobile applications. I specialize in **Flutter, Android (Java/Kotlin), Payment Gateway Integration, Live Tracking, and more.**

---

## 🚀 About Me
- 📱 **Mobile Developer** | Flutter & Android (Java/Kotlin)
- 🛒 Experience in **E-commerce & Delivery** applications
- 💳 **Payment Gateway Integration** (Razorpay, Stripe, PayPal)
- 📍 **Live Tracking Implementation** (Google Maps API, Geofencing, Background Location Updates)
- 🎯 Passionate about **optimizing performance & user experience**
- 📚 Constantly learning **DSA & System Design**

---

## 📂 My Projects
### 🛍 E-commerce & Delivery Apps
- Implemented **secure payments** & optimized **real-time tracking** for deliveries.
- Improved app **performance & scalability** with best coding practices.

### 💳 Payment Integrations
- Integrated **Razorpay, Stripe, and PayPal** in Flutter apps.
- Ensured smooth transactions & secure payment handling.

### 📍 Live Tracking
- Built **real-time location tracking** for delivery services.
- Used **Google Maps API & Geofencing** for accurate results.
...
- **Tools:** Firebase, Google Maps API, Razorpay, Stripe, PayPal
...
[quran]: https://github.com/
[dsccui]: https
[flutter_isb]: http://facebook.com
[profile]: https://mhmz.devww
[resume]: [https://mhmz.dev/resume](https://drive.google.com/file/d/10GoG5pWQWKdc7sCmy-s8pa3ZMN04QPbm/view?usp=sharing)
